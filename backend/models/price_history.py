...
class PriceHistory(SQLModel, table=True):
    ...
    change_reason: str = Field(default=ChangeReason.MANUAL.value, sa_column=Column(String(50), nullable=False))
    ...
    # Revenue tracking
    revenue_before: Decimal | None = Field(default=None, decimal_places=2)
    revenue_after: Decimal | None = Field(default=None, decimal_places=2)
    revenue_impact: Decimal | None = Field(default=None, decimal_places=2)
