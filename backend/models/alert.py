...
class AlertConfiguration(SQLModel, table=True):
    ...
    product_ids: list[UUID] | None = Field(default=None, sa_column=Column(ARRAY(String)))
...
class Alert(SQLModel, table=True):
    ...
    channels_sent: list[str] = Field(default_factory=list, sa_column=Column(ARRAY(String)))
    channels_failed: list[str] = Field(default_factory=list, sa_column=Column(ARRAY(String)))
    ...
    # Relationships
    configuration: AlertConfiguration | None = Relationship(back_populates="alerts")
