...
class SentimentAggregator:
    ...
    async def get_product_sentiment(self, product_id: UUID, hours: int = 24) -> dict:
        """
    ...
    async def get_user_sentiment(self, user_id: UUID, hours: int = 24) -> dict:
    ...
    async def get_sentiment_velocity(self, product_id: UUID, current_hours: int = 6, previous_hours: int = 6) -> dict:
        """
    ...
    async def get_sentiment_by_source(self, product_id: UUID, hours: int = 24) -> dict:
    ...
    def _calculate_aggregation(self, mentions: list[SocialMention], product_id: UUID | None, hours: int) -> dict:
    ...
    def _empty_aggregation(self, product_id: UUID | None, hours: int) -> dict:
    ...
    def _avg_sentiment(self, mentions: list[SocialMention]) -> float | None:
