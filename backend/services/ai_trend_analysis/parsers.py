...
class ResponseParser:
    ...
    def parse_analysis_response(
        ...
        try:
            market_sentiment = TrendDirection(ai_response.get("market_sentiment", "stable"))
        except ValueError:
        ...
        # Parse opportunities
        opportunities = ResponseParser._parse_opportunities(ai_response.get("opportunities", []), products, now)
    ...
    def _parse_opportunities(
        opportunities_data: list, products: list[Product], now: datetime
