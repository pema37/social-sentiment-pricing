...
class PriceSyncService:
    ...
    async def get_live_price(self, product: Product, user_id: UUID) -> Decimal | None:
        """
    ...
    async def sync_product_price(self, product: Product, user_id: UUID) -> bool:
        """
    ...
    async def _get_active_link(self, product_id: UUID, user_id: UUID) -> tuple:
    ...
    async def _fetch_from_platform(self, link, integration) -> Decimal | None:
