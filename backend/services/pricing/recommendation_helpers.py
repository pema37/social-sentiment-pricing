...
class PriceCalculator:
    ...
    @staticmethod
    def _match_competitor(rule: PricingRule, signals: MarketSignals) -> Optional[Decimal]:
    ...
    @staticmethod
    def _undercut_competitor(rule: PricingRule, signals: MarketSignals) -> Optional[Decimal]:
...
class ReasoningGenerator:
    ...
    def generate(
        ...
        detail = ReasoningGenerator._get_rule_type_detail(
            rule_type, match_details, rule
        )
        
        return base + detail
    
    @staticmethod
    def _get_rule_type_detail(
        rule_type: str,
        match_details: dict,
        rule: PricingRule
    ) -> str:
