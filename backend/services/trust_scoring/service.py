...
class TrustScoringService:
    ...
    def calculate_trust_adjusted_sentiment(
        ...
        campaign_result: CampaignDetectionResult | None = None
        ...
        if check_campaign and len(weighted_mentions) >= 10:
            ...
            campaign_result = self.campaign_detector.detect(mention_data, product_id, period_hours)
        ...
        high_trust_count = trust_level_counts.get(TrustLevel.VERIFIED.value, 0) + trust_level_counts.get(
    ...
    def detect_campaign(
        ...
        return self.campaign_detector.detect(mention_data, product_id, time_window_hours)
...
_trust_service: TrustScoringService | None = None
