...
class MarketTrendsService:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Market Trends - Gemini: {self.gemini_client is not None}, OpenAI: {self.openai_client is not None}"
        )
    ...
    async def get_trends(self, category: str | None = None, source: str | None = None, limit: int = 10) -> dict:
    ...
    def _fallback_trends(self, category: str | None, limit: int) -> dict:
