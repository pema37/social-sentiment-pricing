...
async def _enrich_with_platform_links(
    ...
    for link in links:
        ...
        platform_map[link.product_id].append(
            PlatformLink(
...
async def list_products(
    ...
    for product in products:
        ...
        product_dict["platforms_linked"] = [pl.model_dump() for pl in platform_map.get(product.id, [])]
...
async def delete_product(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Failed to delete product: {e!s}",
        )
