...
class AnalyzeRequest(BaseModel):
    ...
    product_features: Optional[list[str]] = Field(default=None, description="List of your product features")
...
async def demo_health_check():
    ...
    return DemoHealthResponse(
        ...
        message="Visual Pricing Intelligence demo is ready!" if gemini_available else "Gemini 3 client not configured. Check GEMINI_API_KEY."
    )
