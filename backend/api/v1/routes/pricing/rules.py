...
async def list_rules(
    request: Request,
    product_id: UUID | None = Query(default=None, description="Filter by product ID"),
    ...
    items_stmt = (
        base_stmt.order_by(PricingRule.priority.desc(), PricingRule.created_at.desc()).offset(offset).limit(page_size)
    )
