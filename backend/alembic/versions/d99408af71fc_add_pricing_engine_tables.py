...
down_revision: Union[str, Sequence[str], None] = 'fe5f2a6d2e42'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'AUTO_APPROVED', 'APPROVED', 'REJECTED', 'APPLIED', 'EXPIRED', name='recommendationstatus'), nullable=False),
    ...
    sa.Column('rule_type', sa.Enum('SENTIMENT_THRESHOLD', 'COMPETITOR_RELATIVE', 'TIME_BASED', 'VOLUME_SURGE', 'VIRAL_DETECTION', name='ruletype'), nullable=False),
    ...
    sa.Column('action', sa.Enum('INCREASE_PERCENT', 'DECREASE_PERCENT', 'SET_ABSOLUTE', 'MATCH_COMPETITOR', 'UNDERCUT_COMPETITOR', name='ruleaction'), nullable=False),
