...
down_revision: Union[str, Sequence[str], None] = '5ddb105edefa'
...
def upgrade() -> None:
    ...
    op.create_table('recommendation_outcomes',
        ...
        sa.Column('outcome_label', sa.Enum('POSITIVE', 'NEGATIVE', 'NEUTRAL', 'INCONCLUSIVE', name='outcomelabel'), nullable=False),
    ...
    op.create_index(op.f('ix_recommendation_outcomes_price_applied_at'), 'recommendation_outcomes', ['price_applied_at'], unique=False)
    op.create_index(op.f('ix_recommendation_outcomes_product_id'), 'recommendation_outcomes', ['product_id'], unique=False)
    op.create_index(op.f('ix_recommendation_outcomes_recommendation_id'), 'recommendation_outcomes', ['recommendation_id'], unique=True)
