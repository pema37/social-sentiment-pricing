...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_competitor_price_history_competitor_product_id", "competitor_price_history", ["competitor_product_id"]
    )
    op.create_index("ix_competitor_price_history_observed_at", "competitor_price_history", ["observed_at"])
