...
class TestCorrelationDrop:
    ...
    def test_critical_correlation(self):
        ...
        records = _make_records(
            ...
            recent_conf=0.5,
            baseline_lift=5.0,
            recent_lift=0.0,  # No lift pattern
        )
        report = self._detector().detect(records)
...
class TestAcceptanceDecline:
    ...
    def test_declining_acceptance(self):
        ...
        assert acc_signals[0].severity in (DriftSeverity.MEDIUM, DriftSeverity.HIGH)
...
class TestLiftDecline:
    ...
    def test_declining_lift(self):
        ...
        if lift_signals:
            assert lift_signals[0].severity in (DriftSeverity.MEDIUM, DriftSeverity.HIGH)
...
class TestVolumeCheck:
    ...
    def test_volume_drop(self):
        ...
        assert vol_signals[0].severity in (DriftSeverity.MEDIUM, DriftSeverity.HIGH)
